...
| 5     | list artifacts via RPC ✅. Download stays on the browser — Studio media URLs 302 cross-origin to googleusercontent.com and Node fetch drops the Cookie header (needs a cookie-jar / manual redirects or the CDP transport). Deferred. | 2–3 d   | list ✅ done                                           |
